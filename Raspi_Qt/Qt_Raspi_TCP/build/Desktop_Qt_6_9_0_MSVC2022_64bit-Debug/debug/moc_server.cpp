...
template <> constexpr inline auto Server::qt_create_metaobjectdata<qt_meta_tag_ZN6ServerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'QRcodeData'
        QtMocHelpers::SignalData<void(const QJsonDocument)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QJsonDocument, 5 },
        }}),
    };
...
void Server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->QRcodeData((*reinterpret_cast< std::add_pointer_t<QJsonDocument>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Server::*)(const QString & )>(_a, &Server::logMessage, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Server::*)(const QJsonDocument )>(_a, &Server::QRcodeData, 1))
            return;
    }
}
...
// SIGNAL 1
void Server::QRcodeData(const QJsonDocument _t1)
{
