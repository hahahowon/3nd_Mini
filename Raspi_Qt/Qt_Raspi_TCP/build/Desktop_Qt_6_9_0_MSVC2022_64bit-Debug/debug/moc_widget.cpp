...
template <> constexpr inline auto Widget::qt_create_metaobjectdata<qt_meta_tag_ZN6WidgetE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "productQMap",
        "productCatalog",
        "on_btn_Server_Start_clicked",
        "on_btn_Server_Stop_clicked",
        "on_btn_Save_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'appendProductQuantity'
        QtMocHelpers::SlotData<void(const QJsonDocument &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QJsonDocument, 3 },
        }}),
        // Slot 'appendLog'
        ...
        // Slot 'productQMap'
        QtMocHelpers::SlotData<void(const QJsonDocument)>(6, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QJsonDocument, 7 },
        }}),
        // Slot 'on_btn_Server_Start_clicked'
        QtMocHelpers::SlotData<void()>(8, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_btn_Server_Stop_clicked'
...
void Widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->appendProductQuantity((*reinterpret_cast< std::add_pointer_t<QJsonDocument>>(_a[1]))); break;
        case 1: _t->appendLog((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->productQMap((*reinterpret_cast< std::add_pointer_t<QJsonDocument>>(_a[1]))); break;
        case 3: _t->on_btn_Server_Start_clicked(); break;
        case 4: _t->on_btn_Server_Stop_clicked(); break;
